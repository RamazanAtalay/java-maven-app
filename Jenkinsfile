...
steps {
script {
echo "\033[35m This is the building the .jar file for the appstep \033[0m"
...
sh "docker build ‐t ratalay35/my‐repo:${IMAGE_NAME} ."
}
}
}
...
https://${GITHUB_APP}:${GITHUB_ACCESS_TOKEN}@github.com/ratalay35/java‐maven‐app.git"
sh 'git add .'
